const About = () => (
  <div className="py-6 md:pt-10 pb-96">
    ...
    <div className="bg-white p-6 md:p-10 flex flex-col sm:flex-row items-center gap-6 md:gap-10 border border-outline/30 mb-8 md:mb-10 text-center sm:text-left">
      ...
      <div>
        <h2 className="text-2xl md:text-3xl font-black text-espresso">Amulya Y.</h2>
        <p className="text-[12px] md:text-[14px] font-black uppercase tracking-widest text-espresso/40 mt-1">Verified Responder · NGP Central Host</p>
      </div>
    </div>
